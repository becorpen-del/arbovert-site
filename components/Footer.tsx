      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-6 px-4 py-10 text-sm sm:px-6 lg:px-8 lg:flex-row lg:items-center lg:justify-between">
        <div>
          ...
          <div className="mt-4 flex items-center gap-3">
            ...
            <a
              href="https://www.facebook.com/profile.php?id=61583601120009"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white/80 hover:text-white transition-colors"
              aria-label="Facebook Arbovert"
            >
            ...
            <a
              href="https://www.instagram.com/sarl.arbovert/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white/80 hover:text-white transition-colors"
              aria-label="Instagram Arbovert"
            >
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
